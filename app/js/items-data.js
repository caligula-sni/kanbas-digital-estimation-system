...
const ITEMS = [
    ...
    { id: 55, name: 'Milo Chocolate Drink Powder (300g)', category: 'food', unit: 'piece', price: 145.00, description: 'Chocolate malt drink powder', verified: false, source: 'Estimated' },
        // Food & Groceries — batch 2, ADR 0013
    { id: 112, name: "Young's Town Sardines (155g)", category: 'food', unit: 'piece', price: 18.00, description: 'In tomato sauce', verified: true, source: 'DTI SRP Bulletin' },
    { id: 113, name: 'Ligo Sardines (155g)', category: 'food', unit: 'piece', price: 21.00, description: 'In tomato sauce', verified: true, source: 'DTI SRP Bulletin' },
    { id: 114, name: 'CDO Corned Beef (150g)', category: 'food', unit: 'piece', price: 32.00, description: 'Canned corned beef', verified: true, source: 'DTI SRP Bulletin' },
    { id: 115, name: 'Purefoods Luncheon Meat (150g)', category: 'food', unit: 'piece', price: 45.00, description: 'Canned luncheon meat', verified: true, source: 'DTI SRP Bulletin' },
    { id: 116, name: 'CDO Luncheon Meat (150g)', category: 'food', unit: 'piece', price: 42.00, description: 'Canned luncheon meat', verified: true, source: 'DTI SRP Bulletin' },
    { id: 117, name: 'Blend 45 Coffee Refill (50g)', category: 'food', unit: 'piece', price: 40.00, description: 'Coffee refill pack', verified: true, source: 'DTI SRP Bulletin' },
    { id: 118, name: 'Kopiko 3-in-1 Coffee (sachet)', category: 'food', unit: 'piece', price: 8.00, description: 'Single sachet', verified: true, source: 'DTI SRP Bulletin' },
    { id: 119, name: 'Great Taste 3-in-1 Coffee (sachet)', category: 'food', unit: 'piece', price: 7.50, description: 'Single sachet', verified: true, source: 'DTI SRP Bulletin' },
    { id: 120, name: 'Pinoy Pandesal (10pcs pack)', category: 'food', unit: 'piece', price: 25.00, description: 'Pack of 10 pandesal', verified: true, source: 'DTI SRP Bulletin' },
    { id: 121, name: "Nature's Spring Distilled Water (1L)", category: 'food', unit: 'piece', price: 16.50, description: 'Distilled drinking water', verified: true, source: 'DTI SRP Bulletin' },
    { id: 122, name: 'SM Bonus Distilled Water (325ml)', category: 'food', unit: 'piece', price: 6.50, description: 'Distilled drinking water', verified: true, source: 'DTI SRP Bulletin' },
    { id: 123, name: 'Green Cross Toilet Soap (55g)', category: 'food', unit: 'piece', price: 15.00, description: 'Bath soap bar', verified: true, source: 'DTI SRP Bulletin' },
    { id: 124, name: 'Sulit Bar Laundry Soap (360g)', category: 'food', unit: 'piece', price: 19.25, description: 'Laundry bar soap', verified: true, source: 'DTI SRP Bulletin' },
    { id: 125, name: 'Royal Elbow Macaroni (400g)', category: 'food', unit: 'piece', price: 45.00, description: 'Pasta, elbow macaroni', verified: false, source: 'Estimated' },
    { id: 126, name: 'Del Monte Spaghetti Sauce (1kg)', category: 'food', unit: 'piece', price: 95.00, description: 'Filipino-style sweet spaghetti sauce', verified: false, source: 'Estimated' },
    { id: 127, name: 'Jolly Spaghetti Sauce (1kg)', category: 'food', unit: 'piece', price: 90.00, description: 'Filipino-style sweet spaghetti sauce', verified: false, source: 'Estimated' },
    { id: 128, name: 'Eden Cheese (165g)', category: 'food', unit: 'piece', price: 75.00, description: 'Processed cheese', verified: false, source: 'Estimated' },
    { id: 129, name: 'Purefoods Tender Juicy Hotdog (1kg)', category: 'food', unit: 'piece', price: 180.00, description: 'Classic hotdog', verified: false, source: 'Estimated' },
    { id: 130, name: 'Swift Hotdog, Regular (500g)', category: 'food', unit: 'piece', price: 95.00, description: 'Regular hotdog', verified: false, source: 'Estimated' },
    { id: 131, name: "Lady's Choice Mayonnaise (220ml)", category: 'food', unit: 'piece', price: 65.00, description: 'Regular mayonnaise', verified: false, source: 'Estimated' },
    { id: 132, name: 'Coca-Cola (1.5L bottle)', category: 'food', unit: 'piece', price: 65.00, description: 'Soft drink', verified: false, source: 'Estimated' },
    { id: 133, name: 'Zesto Juice Drink (200ml)', category: 'food', unit: 'piece', price: 10.00, description: 'Juice drink, tetra pack', verified: false, source: 'Estimated' },
    ...
    { id: 63, name: 'Screwdriver Set', category: 'hardware', unit: 'piece', price: 180.00, description: '5-piece flathead/Phillips set', verified: false, source: 'Estimated' },
        // Hardware & Woodwork — expansion batch, ADR 0014
    { id: 137, name: 'Tolsen Cordless Drill 12V', category: 'hardware', unit: 'piece', price: 1850.00, description: 'Cordless drill driver, 12V, with battery', verified: false, source: 'Estimated' },
    { id: 138, name: 'INGCO Impact Drill 20V', category: 'hardware', unit: 'piece', price: 2450.00, description: 'Brushless cordless impact drill', verified: false, source: 'Estimated' },
    { id: 139, name: 'Makita Angle Grinder 4"', category: 'hardware', unit: 'piece', price: 1950.00, description: 'Corded angle grinder, 4 inch disc', verified: false, source: 'Estimated' },
    { id: 140, name: 'Bosch Jigsaw GST 650', category: 'hardware', unit: 'piece', price: 3200.00, description: 'Corded jigsaw', verified: false, source: 'Estimated' },
    { id: 141, name: 'DeWalt Circular Saw 7-1/4"', category: 'hardware', unit: 'piece', price: 5500.00, description: 'Corded circular saw', verified: false, source: 'Estimated' },
    { id: 142, name: 'Total Electric Planer', category: 'hardware', unit: 'piece', price: 1650.00, description: 'Corded wood planer', verified: false, source: 'Estimated' },
    { id: 143, name: 'Tolsen Adjustable Wrench 10"', category: 'hardware', unit: 'piece', price: 220.00, description: 'Adjustable wrench', verified: false, source: 'Estimated' },
    { id: 144, name: 'Stanley Tape Measure 5m', category: 'hardware', unit: 'piece', price: 195.00, description: 'Retractable tape measure', verified: false, source: 'Estimated' },
    { id: 145, name: 'INGCO Combination Plier 8"', category: 'hardware', unit: 'piece', price: 165.00, description: 'Combination plier', verified: false, source: 'Estimated' },
    { id: 146, name: 'Tolsen Utility Knife', category: 'hardware', unit: 'piece', price: 65.00, description: 'Retractable utility knife', verified: false, source: 'Estimated' },
    { id: 147, name: 'Stanley Spirit Level 24"', category: 'hardware', unit: 'piece', price: 350.00, description: 'Aluminum spirit level', verified: false, source: 'Estimated' },
    { id: 148, name: 'INGCO Wood Chisel Set (6pcs)', category: 'hardware', unit: 'piece', price: 450.00, description: '6-piece wood chisel set', verified: false, source: 'Estimated' },
    { id: 149, name: 'Total Hand Saw 20"', category: 'hardware', unit: 'piece', price: 195.00, description: 'Wood hand saw', verified: false, source: 'Estimated' },
    { id: 150, name: 'Tolsen Hacksaw Frame', category: 'hardware', unit: 'piece', price: 145.00, description: 'Adjustable hacksaw frame', verified: false, source: 'Estimated' },
    { id: 151, name: 'Stanley Socket Wrench Set (24pcs)', category: 'hardware', unit: 'piece', price: 850.00, description: '24-piece socket wrench set', verified: false, source: 'Estimated' },
    { id: 152, name: 'INGCO Allen Key Set', category: 'hardware', unit: 'piece', price: 95.00, description: 'Hex key set, assorted sizes', verified: false, source: 'Estimated' },
    { id: 153, name: '3M Sandpaper, Assorted Grit (5pcs)', category: 'hardware', unit: 'piece', price: 85.00, description: 'Assorted grit sandpaper sheets', verified: false, source: 'Estimated' },
    { id: 154, name: "Elmer's Carpenter's Wood Glue (1L)", category: 'hardware', unit: 'piece', price: 320.00, description: 'Heavy-duty wood glue', verified: false, source: 'Estimated' },
    { id: 155, name: 'Rugby Wood Putty (1kg)', category: 'hardware', unit: 'piece', price: 145.00, description: 'Wood filler putty', verified: false, source: 'Estimated' },
    { id: 156, name: 'Boysen Wood Stain, Walnut (1L)', category: 'hardware', unit: 'piece', price: 285.00, description: 'Wood stain finish', verified: false, source: 'Estimated' },
    { id: 157, name: 'Davies Epoxy Primer (1L)', category: 'hardware', unit: 'piece', price: 310.00, description: 'Epoxy metal primer', verified: false, source: 'Estimated' },
    { id: 158, name: '3M Masking Tape, 1 inch', category: 'hardware', unit: 'piece', price: 45.00, description: 'Masking tape roll', verified: false, source: 'Estimated' },
    { id: 159, name: 'Panther Common Wire Nails, 2 inch (1kg)', category: 'hardware', unit: 'kg', price: 48.00, description: 'Common wire nails', verified: false, source: 'Estimated' },
    { id: 160, name: 'Torch Umbrella Nails (1kg)', category: 'hardware', unit: 'kg', price: 52.00, description: 'Umbrella head roofing nails', verified: false, source: 'Estimated' },
    { id: 161, name: 'Marina Wood Screws, Assorted (100pcs)', category: 'hardware', unit: 'piece', price: 65.00, description: 'Assorted wood screws, pack of 100', verified: false, source: 'Estimated' },
    { id: 162, name: 'Phoenix Cutting Disc, 4 inch', category: 'hardware', unit: 'piece', price: 55.00, description: 'Metal cutting disc for angle grinder', verified: false, source: 'Estimated' },
    { id: 163, name: 'Tolsen Safety Goggles', category: 'hardware', unit: 'piece', price: 85.00, description: 'Clear safety goggles', verified: false, source: 'Estimated' },
    { id: 164, name: 'INGCO Work Gloves, Leather', category: 'hardware', unit: 'piece', price: 120.00, description: 'Leather work gloves, pair', verified: false, source: 'Estimated' },
